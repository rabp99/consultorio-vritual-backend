        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $patient->person_doc_type]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $patient->person_doc_type]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $patient->person_doc_type], ['confirm' => __('Are you sure you want to delete # {0}?', $patient->person_doc_type)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
