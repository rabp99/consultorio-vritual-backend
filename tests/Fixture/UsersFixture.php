...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'username' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'email' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'password' => ['type' => 'string', 'length' => 300, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_users_employees1_idx' => ['type' => 'index', 'columns' => ['employee_person_doc_type', 'employee_person_doc_num'], 'length' => []],
        ],
        '_constraints' => [
